...
const SIDE_WALL_SRC = getAssetSrc('room/wall/wall_middle_01.png');
      ...
      <div className="office-board-wrap">
        ...
        >
          ...
          <div className="side-wall-layer" aria-hidden="true">
            <div
              className="side-wall side-wall-left"
              style={{ '--side-wall-image': `url(${SIDE_WALL_SRC})` } as CSSProperties}
            />
            <div
              className="side-wall side-wall-right"
              style={{ '--side-wall-image': `url(${SIDE_WALL_SRC})` } as CSSProperties}
            />
          </div>
